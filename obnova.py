...
class PydroidBot:
    ...
    def run(self):
        @self.client.on(events.NewMessage(pattern=r'\/ttterror'))
        ...
        @self.client.on(events.NewMessage(pattern='/tttime'))
        ...
        @self.client.on(events.NewMessage(pattern='/ssstop'))
        ...
        @self.client.on(events.NewMessage(pattern='/iiid'))
